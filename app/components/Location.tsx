const locationStats = [
  ...
  { value: "5 min", label: "Grace Bay Beach" },
    ...
    <section className="location" id="location">
      <div className="location__intro">
        ...
        <p className="section-body location__body">
          ...
          Caribbean, Ocean Breeze places you minutes from Grace Bay, consistently
          ranked the world&apos;s finest beach, and just 15 minutes from
